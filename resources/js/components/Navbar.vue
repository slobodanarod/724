                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <nav class="navbar navbar-expand-lg navbar-light bg-dark1 justify-content-sm-start">
                            <router-link class="order-1 order-lg-0 ml-lg-0 ml-3 mr-auto" to="/">
                                <img src="/front/images/logo.png" alt="724 chat" class="logov1">
                            </router-link>
                            ...
                            <div
                                ...
                                <ul class="navbar-nav align-self-stretch" v-if="lang === 'tr'">
                                    ...
                                    <li class="nav-item">
                                        <router-link class="nav-link" to="/onlines">Çevrimiçi Üyeler</router-link>
                                    </li>

                                    <li class="nav-item">
                                        <router-link class="nav-link" to="/last-users">Son Üyeler</router-link>
                                    </li>
                                </ul>
                                <ul class="navbar-nav align-self-stretch" v-else>
                                    ...
                                    <li class="nav-item">
                                        <router-link class="nav-link" to="/onlines">Online Members</router-link>
                                    </li>

                                    <li class="nav-item">
                                        <router-link class="nav-link" to="/last-users">Last Members</router-link>
                                    </li>
...
<!--
                            <ul class="group-icons" v-if="!this.$store.getters.isAuthenticated">
                                <li><img @click="changelang('tr')" src="/images/turkey.png" alt="türkçe"></li>
                                <li><img @click="changelang('en')" src="/images/england.png" alt="english"></li>
                            </ul>
                            -->

                            <ul class="group-icons" v-if="this.$store.getters.isAuthenticated">
                                <li>
                                    <router-link to="/actions/smiles/in" class="icon-set"><i class="fas fa-smile"></i>
                                    </router-link>
                                </li>
                                <li class="dropdown">
                            ...
                            <div class="account order-1 dropdown" v-if="this.$store.getters.isAuthenticated">
                                <a href="#" class="account-link dropdown-toggle-no-caret" role="button"
                                   data-toggle="dropdown">
                                    ...
                                    <span v-if="lang === 'tr'">Hesabım</span>
                                ...
                                <div class="dropdown-menu account-dropdown dropdown-menu-right" v-if="lang === 'tr'">
                                    ...
                                    <router-link class="link-item" to="/actions/viewer/in">Profilini Gezenler
                                    </router-link>
                                    <a class="link-item" style="cursor:pointer" @click.prevent="logout">Çıkış Yap</a>
                                </div>
                                ...
                                <div class="dropdown-menu account-dropdown dropdown-menu-right" v-else>
                                    ...
                                    <a class="link-item" @click.prevent="logout">Logout</a>
                                </div>
                            </div>
