                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="search-bar-main">
                                        <div class="button-group">
                                            <router-link to="/actions/viewer/in" class="btn btn-info col-md-6" style="float:left">Gezenler
                                            </router-link>
                                        ...
                                        <div style="margin:10px 0;">
                                            <router-link to="/actions/smiles/in" class="alt-link-active">Gülümseyenler  </router-link>
                                            |
                                            <router-link to="/actions/smiles/out" class="alt-link">Gülümsediklerim  </router-link>
    ...
    export default {
        ...
        }, mounted ()
        {
            ...
            get (page = 1)
            {
                ...
                window.axios.post("/actions/smiles/in?page=" + page, data).then((res) => {
