                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="search-bar-main">
                                        <div class="button-group">
                                            <router-link to="/actions/viewer/in" class="btn btn-info col-md-6 active"
                                                         style="float:left">Gezenler
                                            </router-link>
                                            <router-link to="/actions/smiles/in" class="btn btn-info col-md-6">
                                                Beğenenler
                                            </router-link>

                                        </div>
                                        <div style="margin:10px 0;">
                                            <router-link to="/actions/viewer/in" class="alt-link-active">Gezenler  </router-link>
                                             |
                                            <router-link to="/actions/viewer/out" class="alt-link">Gezdiklerim
                                            </router-link>
    ...
    export default {
        ...
        }, mounted ()
        {
            ...
            get (page = 1)
            {
                ...
                window.axios.post("/actions/viewer/in?page=" + page, data).then((res) => {
