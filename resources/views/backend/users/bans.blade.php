        ...
        <main>
            <div class="container-fluid">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Banlı Üyeler</li>
                </ol>

                <div class="card mb-4">
                    <div class="card-header"><i class="fas fa-table mr-1"></i>Banlı üyeler Listesi</div>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                @foreach($users as $user)
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route("admin.users.banned",$user["id"]) }}">Yasak Kaldır</a></td>
